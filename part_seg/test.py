...
import provider
import part_seg.pointnet_part_seg_old_2 as model

parser = argparse.ArgumentParser()
parser.add_argument('--model_path', default='train_results_old_2/trained_models/epoch_200.ckpt', help='Model checkpoint path')
...
gpu_to_use = 0
output_dir = os.path.join(BASE_DIR, './test_results/old_2')
